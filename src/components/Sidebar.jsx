...
import { links } from "../data/data/dummy.js";
...
const Sidebar = () => {
  ...
  const normalLink = 'flex items-center  gap-5 pl-4 pt-3 pb2.5 rounded-lg text-gray  text-md text-gray-700 dark:text-gray-200 dark:hover:text-black hover:bg-light-gray m-2'
        ...
        <>
          <div className="flex justify-between items-center">
            <Link
              ...
              className="
              items-center gap-3 ml-3 mt-4 flex
