...
const Ecommerce = () => {
  return (
    <div className="mx-12 mt-6 ">
      ...
      >
        <div
          className="bg-white dark:bg-secondary-dark-bg h-44 rounded-xl
          w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat  bg-center"
        >
          <div>
